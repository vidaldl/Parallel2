...
return [
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'vidaldl'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'parallel'),
            'repository_url' => 'https://github.com/vidaldl/parallel.git',
