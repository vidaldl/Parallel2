...
;(function($, window, undefined) {
  ...
  $.fn.tabslet = function(options) {
    ...
    return this.each(function() {
      ...
      // Autorotate
      var elements = $this.find('> ul > li'), i = options.actives - 1; // ungly
      ...
      if ( !$this.data( 'tabslet-init' ) ) {
        ...
        $this.opts['actives'] = $this.opts.deeplinking ? deep_link() : ( $this.data('actives') || options.actives )

        _tabs.hide();

        if ( $this.opts.actives ) {
          _tabs.eq($this.opts.actives - 1).show();
          elements.eq($this.opts.actives - 1).addClass(options.activeclass);
        }
        ...
        function deep_link() {
          ...
          if (index > -1) {
            ...
            return ($this.data('actives') || options.actives)
